                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    ...
                                    <p class="card-category">Complete todos los campos para crear un medicamento</p>
                                </div>
                                <div class="card-body">
                                @if ($errors->any())
                                ...
                                @endif
                                    <form action="{{route('medicamentos.store')}}" enctype="multipart/form-data" method="post" class="form-horizontal">
                                        @csrf
                                        <div class="form">
                                            <div class="row">
